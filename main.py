...
async def main():
    async with bot:
        ...
        try:
            await USER.join_chat("LIVE_LIFE_LIKE")
...
bot.run(main())
bot.start()
print("\n\nRadio Player Bot Started, Join @LIVE_LIFE_LIKE!")
bot.send(
    SetBotCommands(
...
async def restart(_, message: Message):
    ...
    try:
        await k.edit("✅ **Restarted Successfully! \nJoin @VEXERA_UPDATES For Update!**")
        await k.reply_to_message.delete()
    except:
        pass

idle()
print("\n\nRadio Player Bot Stopped, Join @live_life_like!")
bot.stop()
